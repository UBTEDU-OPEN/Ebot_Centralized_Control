...
//    AlphaRobotLog::getInstance()->printDebug("xxxxxxxxxxxxxxxxx Before WriteFile");

    res = WriteFile(dev->device_handle, buf, length, NULL, &ol);

//    AlphaRobotLog::getInstance()->printDebug("xxxxxxxxxxxxxxxxx after WriteFile");
...
//    AlphaRobotLog::getInstance()->printDebug("xxxxxxxxxxxxxxxxxxxxxxx Before write GetOverlappedResult");

    res = GetOverlappedResult(dev->device_handle, &ol, &bytes_written, TRUE/*wait*/);

//    AlphaRobotLog::getInstance()->printDebug("xxxxxxxxxxxxxxxxxxxxxxxxxx after write GetOverlappedResult");
...
//    AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyyyyyy hid_read_timeout: %1").arg(milliseconds));
    ...
    if (!dev->read_pending) {
        ...
        ResetEvent(ev);
//        AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyy before ReadFile"));
        res = ReadFile(dev->device_handle, dev->read_buf, dev->input_report_length, &bytes_read, &dev->ol);
//        AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyy after ReadFile"));
        if (!res) {
            if (GetLastError() != ERROR_IO_PENDING) {
                /* ReadFile() has failed.
...
//        AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyyyyyyyyyyyyyy before read WaitForSingleObject"));

        /* See if there is any data yet. */
        res = WaitForSingleObject(ev, milliseconds);

//        AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy after read WaitForSingleObject"));
...
//    AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyyyyyyyy before read GetOverlappedResult"));
...
//    AlphaRobotLog::getInstance()->printDebug(QString("yyyyyyyyyyyyyyyyyyyyyyyyyyyy after read GetOverlappedResult"));
