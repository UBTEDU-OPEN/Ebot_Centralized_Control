...
#include "qroundprogressbar_global.h"
 ...
 */
class QROUNDPROGRESSBARSHARED_EXPORT QRoundProgressBar : public QWidget
{
    Q_OBJECT
public:
    ...
    * \sa setMaximum, setRange
    ...
    float innerOuterRate() const { return m_innerOuterRate; }
    void setInnerOuterRate(float r) { m_innerOuterRate = r;}
