...
{
    m_btnGroupForPages.addButton(ui->pbNum1, UBXWidgetConstants::BTN_PAGES_NUM_1);
    m_btnGroupForPages.addButton(ui->pbNum2, UBXWidgetConstants::BTN_PAGES_NUM_2);
    m_btnGroupForPages.addButton(ui->pbNum3, UBXWidgetConstants::BTN_PAGES_NUM_3);
    m_btnGroupForPages.addButton(ui->pbNum4, UBXWidgetConstants::BTN_PAGES_NUM_4);
    m_btnGroupForPages.addButton(ui->pbNum5, UBXWidgetConstants::BTN_PAGES_NUM_5);
    m_btnGroupForPages.addButton(ui->pbNum6, UBXWidgetConstants::BTN_PAGES_NUM_6);
    m_btnGroupForPages.addButton(ui->pbNum7, UBXWidgetConstants::BTN_PAGES_NUM_7);
    m_btnGroupForPages.addButton(ui->pbNum8, UBXWidgetConstants::BTN_PAGES_NUM_8);
    m_btnGroupForPages.addButton(ui->pbNum9, UBXWidgetConstants::BTN_PAGES_NUM_9);
    m_btnGroupForPages.addButton(ui->pbNum10, UBXWidgetConstants::BTN_PAGES_NUM_10);
    ...
    for(int i = 0; i < nCount; i++)
    {
        ...
        btn->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
    }
    ui->pbNumDot1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
    ui->pbNumDot2->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
...
void UBXMultiPage::UpdatePages(int nTotalPage)
{
    ...
    if(m_nTotalPage <= m_nPagebtns) //总页码数小于页码按钮个数，不显示"..."
    {
        ...
        {
            QAbstractButton* btn = m_btnGroupForPages.buttons().at(i);
            btn->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, i+1);
        }
        ui->pbNumDot1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
        ui->pbNumDot2->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
    }
    else //总页码大于按钮个数，需要显示"..."
    {
        ...
        if(m_nCurrentPage > nleftPageCount + 1 && m_nCurrentPage < m_nTotalPage - nRightPageCount)
        {
            ...
            btn1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, 1);//第一页
            //设置...显示
            ui->pbNumDot1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, 0);//...

            int i = 1; //第二个页码按钮开始
            for(; i <= m_nPagebtns - 2; i++)
            {
                QAbstractButton* btn = m_btnGroupForPages.buttons().at(i);
                btn->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, m_nCurrentPage - nleftPageCount + i);
            }

            ui->pbNumDot2->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, 0);//最后一页前的...
            QAbstractButton* btn2 = m_btnGroupForPages.buttons().at(i);
            btn2->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, m_nTotalPage);//最后一页
        }
        ...
        else if(m_nCurrentPage >= m_nTotalPage - nRightPageCount)
        {
            ...
            {
                QAbstractButton* btn = m_btnGroupForPages.buttons().at(i);
                btn->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, m_nTotalPage - m_nPagebtns + 1 + i);
            }
        }
        else
        {
            ...
            ui->pbNumDot1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, -1);
            //设置显示...
            ui->pbNumDot2->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, 0);
            int i = 0;
            for(; i <= m_nPagebtns - 2; i++)
            {
                QAbstractButton* btn = m_btnGroupForPages.buttons().at(i);
            ...
            btn1->setProperty(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER, m_nTotalPage);
        }
    }

    //更新界面
    int nNumDot1 = ui->pbNumDot1->property(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER).toInt();
    if(-1 == nNumDot1)
    {
        ui->pbNumDot1->hide();
    }
    ...
    int nNumDot2 = ui->pbNumDot2->property(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER).toInt();
    if(-1 == nNumDot2)
    {
        ui->pbNumDot2->hide();
    }
    ...
    foreach (QAbstractButton* btn, m_btnGroupForPages.buttons())
    {
        int nNum = btn->property(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER).toInt();
        if(-1 == nNum)
        {
            btn->hide();
        }
...
void UBXMultiPage::onBtnsButtonToggled(int id, bool bChecked)
{
    ...
    if(btn)
    {
        nNum = btn->property(UBXWidgetConstants::PROPERTY_PAGE_REAL_NUMBER).toInt();
    }
