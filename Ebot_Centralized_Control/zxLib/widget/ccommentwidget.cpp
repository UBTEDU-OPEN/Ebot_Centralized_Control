...
CCommentWidget::CCommentWidget(QWidget *parent) :
    QWidget(parent),
    m_nMaxCommentCharNumber(zxLibConstConstants::COMMENT_MAX_CHARACTOR_NUMBER),
...
void CCommentWidget::setReplyToWho(quint64 nCommentId, const QString &strWho)
{
    ...
    fontReplyToWho.setPointSize(zxLibConstConstants::FONT_POINT_SIZE_10);
    ui->textEditComment->setFont(fontReplyToWho);
    ui->textEditComment->setTextColor(QColor(zxLibConstConstants::UBX_COLOR_DARK_GREY)); // #858585
