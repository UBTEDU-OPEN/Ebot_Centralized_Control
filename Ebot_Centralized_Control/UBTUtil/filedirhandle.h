...
class UBTUTILSHARED_EXPORT CFileDirHandle
{
public:
    CFileDirHandle();
    ~CFileDirHandle();
...
public:
    ...
    static bool mkPathIfNotExist(const QString& strPath);
    ...
    static QString getFileCompleteSuffix(const QString &strFilePath);
